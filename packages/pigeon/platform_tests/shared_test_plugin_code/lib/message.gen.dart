...
class MessageApi {
  ...
  Future<void> initialize() async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.shared_test_plugin_code.MessageApi.initialize$pigeonVar_messageChannelSuffix';
  ...
  Future<MessageSearchReply> search(MessageSearchRequest request) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.shared_test_plugin_code.MessageApi.search$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
...
class MessageNestedApi {
  ...
  Future<MessageSearchReply> search(MessageNested nested) async {
    final String pigeonVar_channelName = 'dev.flutter.pigeon.shared_test_plugin_code.MessageNestedApi.search$pigeonVar_messageChannelSuffix';
    final BasicMessageChannel<Object?> pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
